...
class Yacona {
    ...
    createOwnServer(){
        this.server = expressController.startup()
    ...
    ownServerAddRoute( directory ){
        return addRoute( this.server, '', this.path, directory )
    }
    ...
    getOwnUrl(){
        return 'http://localhost:' + this.getOwnServerPort() + '/'
    }
