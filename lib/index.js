...
class Yacona {
    ...
    createWindow( url, options, fn ){
        ...
        if( createWindow === undefined ){
            ...
            if( utility.isExist( utility.fixPath( app.getPath( 'appData' ), 'yacona' ) ) === false ) 
                file.mkdirSync( utility.fixPath( app.getPath( 'appData' ), 'yacona' ) )
            if( utility.isExist( utility.fixPath( app.getPath( 'documents' ), 'yacona' ) ) === false ) 
                file.mkdirSync( utility.fixPath( app.getPath( 'documents' ), 'yacona' ) )
